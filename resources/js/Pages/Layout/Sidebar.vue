<template>
  <div>
    ...
    <!-- Sidebar -->
    <aside class="w-64 bg-white border-r border-gray-200 fixed h-screen overflow-y-auto flex flex-col px-4 py-4 sidebar-font transition-transform duration-300 ease-in-out z-50" :class="sidebarClasses">
      ...
      <nav class="space-y-2 flex-1">
        ...
        <div>
          <button 
            ...
            class="w-full flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors sidebar-font"
          >
      ...
      <div class="sidebar-collapsed-text cursor-pointer hover:underline px-2 pt-4 mt-auto" @click="toggleCollapsed">
...
// Emits
const emit = defineEmits(['menu-click', 'close-mobile'])
