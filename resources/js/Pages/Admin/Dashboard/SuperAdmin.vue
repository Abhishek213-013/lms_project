    ...
    <div class="flex-1 w-full lg:ml-64 transition-all duration-300">
      ...
      <div class="p-3 sm:p-4 lg:p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
          ...
          <Link href="/admin/payment-verification" class="no-underline-card bg-white p-3 sm:p-4 rounded-lg shadow-sm border border-gray-200 hover:border-green-500 transition-colors text-left block">
            <div class="flex items-center space-x-2 sm:space-x-3">
              ...
              <div class="min-w-0 flex-1">
                <h3 class="font-semibold text-gray-800 text-xs sm:text-sm truncate">Payment Verification</h3>
                <p class="text-gray-600 text-xs truncate">Verify pending payments</p>
              </div>
            </div>
          </Link>
