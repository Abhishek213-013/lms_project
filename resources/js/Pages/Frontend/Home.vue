    ...
    <div class="home-page">
      ...
      <section class="features-section py-5">
        <div class="container">
          <div class="row text-center mb-5">
            <div class="col-12">
              <h2 class="fw-bold mb-3">Why Choose SkillGro?</h2>
              <p class="lead">Learn from industry experts and advance your career</p>
            </div>
          </div>
          <div class="row">
        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 text-center">
              ...
              <p class="lead">Discover our most enrolled courses</p>
            </div>
          </div>
          <div class="row">
              ...
              <div class="card course-card h-100">
                ...
                <div class="card-body">
                  ...
                  <div class="course-info d-flex justify-content-between align-items-center">
                    ...
                    <strong class="text-primary">${{ course.fee }}</strong>
                  </div>
                </div>
      ...
      <section class="instructors-section py-5" v-if="instructors.length > 0">
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 text-center">
              <h2 class="fw-bold mb-3">Meet Our Instructors</h2>
              <p class="lead">Learn from experienced professionals</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3 mb-4" v-for="instructor in instructors.slice(0, 4)" :key="instructor.id">
              <div class="instructor-card text-center p-4">
                ...
                <p class="text-muted small">{{ instructor.education_qualification }}</p>
                <p class="text-muted small mb-3">{{ instructor.experience }} years experience</p>
                <Link :href="`/instructor/${instructor.id}`" class="btn btn-outline-primary btn-sm">
                  View Profile
                </Link>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row text-center">
            <div class="col-md-3 mb-4">
              <h3 class="fw-bold display-4">{{ stats.total_students.toLocaleString() }}+</h3>
              <p class="mb-0">Students Enrolled</p>
            </div>
            <div class="col-md-3 mb-4">
              <h3 class="fw-bold display-4">{{ stats.total_instructors }}+</h3>
              <p class="mb-0">Expert Instructors</p>
            </div>
            <div class="col-md-3 mb-4">
              <h3 class="fw-bold display-4">{{ stats.total_courses }}+</h3>
              <p class="mb-0">Courses Available</p>
            </div>
            <div class="col-md-3 mb-4">
              <h3 class="fw-bold display-4">{{ stats.total_enrollments.toLocaleString() }}+</h3>
      ...
      <section class="testimonials-section py-5 bg-light" v-if="testimonials.length > 0">
        <div class="container">
          <div class="row mb-5">
            <div class="col-12 text-center">
              <h2 class="fw-bold mb-3">What Our Students Say</h2>
              <p class="lead">Hear from our successful students</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-4" v-for="testimonial in testimonials" :key="testimonial.id">
              <div class="testimonial-card p-4 bg-white rounded shadow-sm">
                ...
                <div class="testimonial-author d-flex align-items-center">
                  <img :src="testimonial.avatar" :alt="testimonial.name" class="rounded-circle me-3" style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
        ...
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              ...
              <p class="lead mb-4">Join thousands of students already learning with SkillGro</p>
